...
add_action( 'wp_enqueue_scripts', function () {
    ...
    wp_enqueue_script( 'magnetic-btn',          $uri . '/assets/js/magnetic-btn.js',          [ 'gsap' ],               $v( '/assets/js/magnetic-btn.js' ),          true );
    wp_enqueue_script( 'menu-scroll-indicator', $uri . '/assets/js/menu-scroll-indicator.js', [ 'gsap-scrolltrigger' ], $v( '/assets/js/menu-scroll-indicator.js' ), true );
